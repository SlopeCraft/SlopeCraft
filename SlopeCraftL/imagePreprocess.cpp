...
inline ARGB composeColor(const ARGB front,const ARGB back) {
    const ARGB red=(getR(front)*getA(front)+getR(back)*(255-getA(front)))/255;
    const ARGB green=(getG(front)*getA(front)+getG(back)*(255-getA(front)))/255;
    const ARGB blue=(getB(front)*getA(front)+getB(back)*(255-getA(front)))/255;
